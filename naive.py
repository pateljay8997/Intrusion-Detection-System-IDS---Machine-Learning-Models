...
with open(os.path.join(results_dir, 'classification_report_naive_bayes.txt'), 'w') as f:
...
plt.ylabel('True')
plt.savefig(os.path.join(results_dir, 'confusion_matrix_naive_bayes.png'))  # Save confusion matrix as an image
plt.show()
